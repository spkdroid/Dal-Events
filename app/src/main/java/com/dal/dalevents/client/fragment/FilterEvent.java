...
import com.dal.dalevents.client.sqlite.LogTableHelper;
import com.dal.dalevents.fragment.DialogView;

public class FilterEvent extends Fragment implements OnClickListener{

	
	Button filter_button;
	Spinner filter;
	private static String filter_url="http://www.spkdroid.com/webapp/filter.php?vai=";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		final View rootView=inflater.inflate(R.layout.filter_event, container,false);
		filter=(Spinner)rootView.findViewById(R.id.contentfilter);	
		filter_button=(Button)rootView.findViewById(R.id.filtersearchbutton);
		filter_button.setOnClickListener(this);
				
		contactList = new ArrayList<HashMap<String, String>>();
		lv =(ListView)rootView.findViewById(R.id.searchfilterlist);
    	return rootView;
	}	
	...
	public void onClick(View v) {
		...
		String r=filter.getSelectedItem().toString();
		r=r.replace(" ","%20");
		url=filter_url+"'"+r+"'";
